...
__d(
  ...
  ["CometLoadingAnimation.react", "react", "useDebouncedValue"],
  function (a, b, c, d, e, f, g) {
    "use strict";
    var h = d("react"),
      i = 36;
    function a(a) {
      ...
      return h.jsx("div", {
        className:
          "xc9qbxq x10l6tqk xtzzx4i xwa60dl x11lhmoz x14qfxbe" +
          (a
            ? " x1hc1fzr x5w5eug x13dflua x19991ni xl405pv"
            : " xg01cxk x2p8vrm x13dflua x1jl3cmp xl405pv xlshs6z"),
  ...
  function (a, b, c, d, e, f, g) {
    ...
    a = (function (a) {
      ...
      function e(b) {
        ...
        e.$Player15 = new (d(
          "oz-player/loggings/OzMultiDestinationPerfLogger"
        ).OzMultiDestinationPerfLoggerProvider)(e.$Player70().concat(n));
        e.$Player2 = f;
        e.$Player4 =
          (m = i) != null
            ? m
        ...
        if (e.$Player4.getBool("clear_on_seek")) {
          ...
          f.maybeOverwriteVideoCurrentTimeProperty();
          e.$Player10.addSubscriptions(f.onError(e.$Player11.emitError));
          e.$Player62 = f;
        }
        e.$Player23 = o;
        i = e.$Player23 && e.$Player23.getCachedRepresentations();
        e.$Player24 = i || u;
        ...
        e.$Player48 = (m = g) != null ? m : e.$Player73();
      ...
      f.$Player77 = function (a) {
        ...
        this.$Player25 = this.$Player78();
        this.$Player26 = this.$Player79();
        ...
        if (this.$Player17 != null) {
          ...
          this.$Player10.addSubscriptions(
            ...
            d.addListener("streamTransitionToStatic", this.$Player82),
            d.addListener("streamGone", this.$Player83)
          );
          d.setupUpdateLoop();
          this.$Player20 = d;
        }
        ...
        this.$Player85()["catch"](function (a) {
      ...
      f.updatePlayerRunTimeConfig = function (a) {
        ...
        b != null && b !== "" && this.$Player89(b);
      };
      f.$Player90 = function (a, b) {
        var c = this,
          e = a.getMimeCodecs();
      ...
      f.$Player91 = function (a, b, e) {
        var f = this,
          ...
          j = new (c("oz-player/streams/OzMediaStream"))({
            ...
            dynamicVideoLibrary: this.$Player63,
            shouldAppendOncePerStream: this.$Player94(b),
            mediaStreamType: b,
          });
        this.$Player36 === 0
          ? j.start()
      ...
      f.$Player79 = function () {
        return this.$Player1 != null
          ? new (c("oz-player/strategies/OzBufferTargetCalculator"))(
              [].concat(this.$Player1, this.$Player99()),
              this.$Player101()
            )
          : this.$Player78();
      };
      ...
      f.$Player85 = function () {
        ...
        c = this.$Player2
          ? [
              this.$Player102({ liveConfigsFromAudioStream: !0 }),
              this.$Player103(),
            ]
          : [this.$Player104(), this.$Player102({}), this.$Player103()];
        var e = [];
        return b("Promise")
          .all(c)
          .then(function () {
      ...
      f.$Player104 = function () {
        ...
        this.$Player106(b[0]);
        a = this.$Player107(b);
        var e = this.$Player92(a || b[0]);
        this.$Player6.set("video", e);
        a || (a = e.getBestRepresentation());
        return this.$Player90(a || b[0], "video");
      };
      f.$Player102 = function (a) {
        ...
        return b.length
          ? this.$Player90(this.$Player108(b) || b[0], "audio")
          : c("oz-player/shims/OzMaybeNativePromise").resolve();
      };
      f.$Player103 = function () {
        ...
        return a.length
          ? this.$Player90(this.$Player109(a) || a[0], "caption")
          : c("oz-player/shims/OzMaybeNativePromise").resolve();
      };
      f.getMpd = function () {
        return this.$Player9;
      ...
      f.destroy = function (a) {
        ...
        (c = this.$Player62) == null ? void 0 : c.destroy();
        this.$Player88();
