...
__d(
  ...
  function (a, b, c, d, e, f) {
    ...
    function h() {
      var a = function (b, c) {
        (this.key = b),
          (c === "ecb" || c === "cbc") && (this.mode = c),
          (this.sBox0 = a.sBox0.slice()),
          (this.sBox1 = a.sBox1.slice()),
          (this.sBox2 = a.sBox2.slice()),
          (this.sBox3 = a.sBox3.slice()),
          (this.pArray = a.pArray.slice()),
          this.generateSubkeys(b);
      };
      a.prototype = {
        sBox0: null,
        sBox1: null,
        ...
        encipher: function (a, b) {
          var c;
          for (var d = 0; d < 16; d++)
            (a = this.xor(a, this.pArray[d])),
              (b = this.xor(this.F(a), b)),
              (c = a),
              (a = b),
              (b = c);
          c = a;
        ...
        generateSubkeys: function (a) {
          ...
          for (d = 0; d < 18; d++) {
            for (e = 4; e > 0; e--)
              (b = this.fixNegative((b << 8) | a.charCodeAt(c))),
                (c = (c + 1) % a.length);
        ...
        num2block32: function (a) {
          return (
            String.fromCharCode(a >>> 24) +
            String.fromCharCode((a << 8) >>> 24) +
            String.fromCharCode((a << 16) >>> 24) +
            String.fromCharCode((a << 24) >>> 24)
          );
        },
        xor: function (a, b) {
          ...
          while (i < a.length)
            (c = a.charCodeAt(i++)),
              ...
              (b =
                ...
                this.keyStr.charAt(g) +
                this.keyStr.charAt(h));
          return b;
        },
        base64Decode: function (a) {
          ...
          while (h < a.length)
            (d = this.keyStr.indexOf(a.charAt(h++))),
              (e = this.keyStr.indexOf(a.charAt(h++))),
              (f = this.keyStr.indexOf(a.charAt(h++))),
              (g = this.keyStr.indexOf(a.charAt(h++))),
              (d = (d << 2) | (e >> 4)),
              (e = ((e & 15) << 4) | (f >> 2)),
              (c = ((f & 3) << 6) | g),
              (b = b + String.fromCharCode(d)),
              f != 64 && (b = b + String.fromCharCode(e)),
              g != 64 && (b = b + String.fromCharCode(c));
          return b;
        },
