...
const buttonVariants = cva(
  "active:scale-95 inline-flex item-center justify-center rounded-md text-sm font-medium transition-color focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 disable:opacity-50 dark:focus:ring-slate-400 disables:pointer-events-none dark:focus:ring-offset-900",
  {
    variants: {
      variant: {
        default:
